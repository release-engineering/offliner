 ...
 */
public class PlaintextAvoidedDownloadFTest
        extends AbstractOfflinerFunctionalTest
{
            ...
            throws Exception
    {
        ...
        assertThat( "Wrong number of downloads logged. Should have been 3 including checksums.", firstMain.getDownloaded(), equalTo( 3 ) );
