        ...
        extends AbstractOfflinerFunctionalTest
{
            ...
            throws Exception
    {
        ...
        server.registerContent( path + Offliner.SHA_SUFFIX, sha1Hex( downloadedContent ) );
        server.registerContent( path + Offliner.MD5_SUFFIX, md5Hex( downloadedContent ) );
